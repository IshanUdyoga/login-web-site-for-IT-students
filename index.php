 ...
 <div class="jumbotron">
   ...
   echo "  <div class='col-lg-3 col-md-3 col-sm-3 col-xs-6'>
    ...
    <img src=   ";
	 ...
	 $sql = "SELECT avatar FROM books WHERE id='$x'";
$result = $db->query($sql);
...
echo "	 />
 ...
 $sql = "SELECT title FROM books WHERE id='$x'";
$result = $db->query($sql);
...
echo "	</h3> ";
 ...
 $sql = "SELECT Description FROM books WHERE id='$x'";
$result = $db->query($sql);
 ...
 echo "   <p><a href='#' class='btn btn-primary' role='button'>Read</a></p>
    </div>
...
<div id="footer">
    <div class="container">
        ...
        <div class="row">
            <h3 class="footertext"><cc>.</cc></h3><br><br>
            <br>
              <div class="col-md-4">
                <center>
...
$result = $db->query($sql);
 ...
 ?>
			...
			<center><p><cc>Developed By Ishan Udyoga</cc></p></center>
        </div>
    </div>
    </div>
</body>
