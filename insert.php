...
$db = new mysqli("localhost", "root", "", "accounts");
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "INSERT INTO usershortbooks (Description)
VALUES ('$discription')";
	...
	<div class="center">
      <div align = "center">
         <div style = "width:300px; border: solid 1px #333333; " align = "left">
            <center><div style = "background-color:#333333; color:#FFFFFF; padding:3px;"><b>Insert</b></div></center>
				
            <div style = "margin:30px">
               
               <form action = "insert.php" method = "post">
			   <label>Write Your Short Story  :</label><textarea name = "discription" class = "box"></textarea><br />
